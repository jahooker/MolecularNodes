...
elements = {
    ...
    "Ti" : {"atomic_number" : 22,  'vdw_radii': 147, "name" : "Titanium"    },  # "Metallic" radius (vdw not listed). What does this mean?
    "V"  : {"atomic_number" : 23,  'vdw_radii': 134, "name" : "Vanadium"    },  # "Metallic" radius (vdw not listed). What does this mean?
    "Cr" : {"atomic_number" : 24,  'vdw_radii': 128, "name" : "Chromium"    },  # "Metallic" radius (vdw not listed). What does this mean?
    "Mn" : {"atomic_number" : 25,  'vdw_radii': 127, "name" : "Manganese"   },  # "Metallic" radius (vdw not listed). What does this mean?
    "Fe" : {"atomic_number" : 26,  'vdw_radii': 126, "name" : "Iron"        },  # "Metallic" radius (vdw not listed). What does this mean?
    "Co" : {"atomic_number" : 27,  'vdw_radii': 125, "name" : "Cobalt"      },  # "Metallic" radius (vdw not listed). What does this mean?
...
residues = {
    # Unknown? Came up in one of the structures. TODO Investigate.
    ...
    # TODO Also add some sugars and such
}
...
SACCHARIDE_NAMES = {res_name: common_name for common_name, res_names in {
    ...
    "Sor": ("SOE"),
    "Psi": ("PSV", "SF6", "SF9"),
}.items() for res_name in res_names}

# Currently not using this, but potential for colouring / default colour glycans
